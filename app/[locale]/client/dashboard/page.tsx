  ...
  const quickActions = [
    {
      href: "/services",
      icon: Search,
      label: l("ابحث عن محترف", "Trouver un pro", "Find a pro"),
      desc:  l("تصفح جميع الخدمات", "Parcourir tous les services", "Browse all services"),
      color: "bg-gradient-to-br from-green-500 to-emerald-600",
    },
    {
      href: "/profile",
      icon: User,
      label: l("ملفي الشخصي", "Mon profil", "My profile"),
      desc:  l("تعديل معلوماتي", "Modifier mes informations", "Edit my info"),
      color: "bg-gradient-to-br from-blue-500 to-indigo-600",
    },
    {
      href: "/contact",
      icon: MessageCircle,
      label: l("تواصل معنا", "Nous contacter", "Contact us"),
      desc:  l("دعم وأسئلة", "Support et questions", "Support & questions"),
      color: "bg-gradient-to-br from-purple-500 to-violet-600",
    },
    {
      href: "/provider/register",
      icon: Sparkles,
      label: l("أصبح محترفاً", "Devenir prestataire", "Become a provider"),
      desc:  l("سجّل نشاطك التجاري", "Inscrivez votre activité", "List your business"),
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-white/60 text-sm">
                {l("مرحباً بك في", "Bienvenue sur", "Welcome to")} khdimti.com
              </p>
              <h1 className="text-2xl font-extrabold text-white">
                {l("أهلاً،", "Bonjour,", "Hello,")} {firstName} 👋
              </h1>
              <div className="flex items-center gap-2 mt-1">
                <ShieldCheck className="h-3.5 w-3.5 text-green-400" />
                <span className="text-green-300 text-xs font-medium">
                  {l("حساب موثوق", "Compte vérifié", "Verified account")}
                </span>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 max-w-4xl -mt-2 pb-16">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden mb-6">
          ...
          {providers.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 text-gray-400">
              ...
              <p className="text-sm">
                {l("لا يوجد محترفون بعد", "Aucun prestataire pour le moment", "No providers yet")}
              </p>
            </div>
          ) : (
        ...
        <div className="rounded-2xl bg-gradient-to-br from-green-700 to-emerald-600 p-6 text-white text-center">
          ...
          <h3 className="font-bold text-lg mb-1">
            {l("هل أنت محترف؟", "Vous êtes un professionnel ?", "Are you a professional?")}
          </h3>
          <p className="text-green-100 text-sm mb-4 max-w-xs mx-auto">
            {l("انضم إلى آلاف المحترفين وابدأ استقبال العملاء اليوم", "Rejoignez des milliers de pros et commencez à recevoir des clients", "Join thousands of pros and start receiving clients today")}
          </p>
          <Button className="bg-white text-green-700 hover:bg-green-50 font-semibold" asChild>
            <Link href="/provider/register">
              {l("سجّل نشاطك", "Inscrivez votre activité", "List your business")}
