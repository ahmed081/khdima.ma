...
async function main() {
  ...
  const citiesData = [
    // Major cities (order 1-15)
    { code: 'CASA',         name: 'Casablanca',        nameAr: 'الدار البيضاء',  nameFr: 'Casablanca',        order: 1  },
    { code: 'RABAT',        name: 'Rabat',             nameAr: 'الرباط',          nameFr: 'Rabat',             order: 2  },
    { code: 'MARRAKECH',    name: 'Marrakech',         nameAr: 'مراكش',           nameFr: 'Marrakech',         order: 3  },
    { code: 'FES',          name: 'Fès',               nameAr: 'فاس',             nameFr: 'Fès',               order: 4  },
    { code: 'TANGER',       name: 'Tanger',            nameAr: 'طنجة',            nameFr: 'Tanger',            order: 5  },
    { code: 'AGADIR',       name: 'Agadir',            nameAr: 'أكادير',          nameFr: 'Agadir',            order: 6  },
    { code: 'MEKNES',       name: 'Meknès',            nameAr: 'مكناس',           nameFr: 'Meknès',            order: 7  },
    { code: 'OUJDA',        name: 'Oujda',             nameAr: 'وجدة',            nameFr: 'Oujda',             order: 8  },
    { code: 'KENITRA',      name: 'Kenitra',           nameAr: 'القنيطرة',        nameFr: 'Kénitra',           order: 9  },
    { code: 'TETOUAN',      name: 'Tétouan',           nameAr: 'تطوان',           nameFr: 'Tétouan',           order: 10 },
    { code: 'SALE',         name: 'Salé',              nameAr: 'سلا',             nameFr: 'Salé',              order: 11 },
    { code: 'MOHAMMEDIA',   name: 'Mohammedia',        nameAr: 'المحمدية',        nameFr: 'Mohammedia',        order: 12 },
    { code: 'BENI_MELLAL',  name: 'Beni Mellal',       nameAr: 'بني ملال',        nameFr: 'Béni Mellal',       order: 13 },
    { code: 'SAFI',         name: 'Safi',              nameAr: 'آسفي',            nameFr: 'Safi',              order: 14 },
    { code: 'TEMARA',       name: 'Témara',            nameAr: 'تمارة',           nameFr: 'Témara',            order: 15 },
    // Other major cities (order 16-50)
    { code: 'EL_JADIDA',    name: 'El Jadida',         nameAr: 'الجديدة',         nameFr: 'El Jadida',         order: 16 },
    { code: 'NADOR',        name: 'Nador',             nameAr: 'الناظور',         nameFr: 'Nador',             order: 17 },
    { code: 'TAZA',         name: 'Taza',              nameAr: 'تازة',            nameFr: 'Taza',              order: 18 },
    { code: 'SETTAT',       name: 'Settat',            nameAr: 'سطات',            nameFr: 'Settat',            order: 19 },
    { code: 'LARACHE',      name: 'Larache',           nameAr: 'العرائش',         nameFr: 'Larache',           order: 20 },
    { code: 'KHOURIBGA',    name: 'Khouribga',         nameAr: 'خريبكة',          nameFr: 'Khouribga',         order: 21 },
    { code: 'KSAR_EL_KEBIR',name: 'Ksar El Kébir',    nameAr: 'القصر الكبير',    nameFr: 'Ksar El Kébir',     order: 22 },
    { code: 'KHEMISSET',    name: 'Khémisset',         nameAr: 'الخميسات',        nameFr: 'Khémisset',         order: 23 },
    { code: 'GUELMIM',      name: 'Guelmim',           nameAr: 'كلميم',           nameFr: 'Guelmim',           order: 24 },
    { code: 'BERRECHID',    name: 'Berrechid',         nameAr: 'برشيد',           nameFr: 'Berrechid',         order: 25 },
    { code: 'FQUIH_BEN_SALAH', name: 'Fquih Ben Salah', nameAr: 'الفقيه بن صالح', nameFr: 'Fquih Ben Salah',  order: 26 },
    { code: 'TAOURIRT',     name: 'Taourirt',          nameAr: 'تاوريرت',         nameFr: 'Taourirt',          order: 27 },
    { code: 'BERKANE',      name: 'Berkane',           nameAr: 'بركان',           nameFr: 'Berkane',           order: 28 },
    { code: 'SIDI_SLIMANE', name: 'Sidi Slimane',      nameAr: 'سيدي سليمان',    nameFr: 'Sidi Slimane',      order: 29 },
    { code: 'ERRACHIDIA',   name: 'Errachidia',        nameAr: 'الراشيدية',       nameFr: 'Errachidia',        order: 30 },
    { code: 'SIDI_KACEM',   name: 'Sidi Kacem',        nameAr: 'سيدي قاسم',      nameFr: 'Sidi Kacem',        order: 31 },
    { code: 'TIZNIT',       name: 'Tiznit',            nameAr: 'تيزنيت',          nameFr: 'Tiznit',            order: 32 },
    { code: 'TAN_TAN',      name: 'Tan-Tan',           nameAr: 'طانطان',          nameFr: 'Tan-Tan',           order: 33 },
    { code: 'OUARZAZATE',   name: 'Ouarzazate',        nameAr: 'ورزازات',         nameFr: 'Ouarzazate',        order: 34 },
    { code: 'SEFROU',       name: 'Sefrou',            nameAr: 'صفرو',            nameFr: 'Sefrou',            order: 35 },
    { code: 'YOUSSOUFIA',   name: 'Youssoufia',        nameAr: 'يوسفية',          nameFr: 'Youssoufia',        order: 36 },
    { code: 'LAAYOUNE',     name: 'Laâyoune',          nameAr: 'العيون',          nameFr: 'Laâyoune',          order: 37 },
    { code: 'TAROUDANT',    name: 'Taroudant',         nameAr: 'تارودانت',        nameFr: 'Taroudant',         order: 38 },
    { code: 'ESSAOUIRA',    name: 'Essaouira',         nameAr: 'الصويرة',         nameFr: 'Essaouira',         order: 39 },
    { code: 'KHENIFRA',     name: 'Khénifra',          nameAr: 'خنيفرة',          nameFr: 'Khénifra',          order: 40 },
    { code: 'OULAD_TEIMA',  name: 'Oulad Teima',       nameAr: 'أولاد تيمة',      nameFr: 'Oulad Teima',       order: 41 },
    { code: 'BEN_GUERIR',   name: 'Ben Guerir',        nameAr: 'بن جرير',         nameFr: 'Ben Guerir',        order: 42 },
    { code: 'TIFELT',       name: 'Tifelt',            nameAr: 'تيفلت',           nameFr: 'Tifelt',            order: 43 },
    { code: 'AZROU',        name: 'Azrou',             nameAr: 'أزرو',            nameFr: 'Azrou',             order: 44 },
    { code: 'MIDELT',       name: 'Midelt',            nameAr: 'ميدلت',           nameFr: 'Midelt',            order: 45 },
    { code: 'OUAZZANE',     name: 'Ouazzane',          nameAr: 'وزان',            nameFr: 'Ouazzane',          order: 46 },
    { code: 'GUERCIF',      name: 'Guercif',           nameAr: 'كرسيف',           nameFr: 'Guercif',           order: 47 },
    { code: 'AL_HOCEIMA',   name: 'Al Hoceima',        nameAr: 'الحسيمة',         nameFr: 'Al Hoceima',        order: 48 },
    { code: 'TARFAYA',      name: 'Tarfaya',           nameAr: 'طرفاية',          nameFr: 'Tarfaya',           order: 49 },
    { code: 'BOUJDOUR',     name: 'Boujdour',          nameAr: 'بوجدور',          nameFr: 'Boujdour',          order: 50 },
    { code: 'ZAGORA',       name: 'Zagora',            nameAr: 'زاكورة',          nameFr: 'Zagora',            order: 51 },
    { code: 'DAKHLA',       name: 'Dakhla',            nameAr: 'الداخلة',         nameFr: 'Dakhla',            order: 52 },
    { code: 'TINGHIR',      name: 'Tinghir',           nameAr: 'تنغير',           nameFr: 'Tinghir',           order: 53 },
    { code: 'IFRANE',       name: 'Ifrane',            nameAr: 'إفران',           nameFr: 'Ifrane',            order: 54 },
    { code: 'CHEFCHAOUEN',  name: 'Chefchaouen',       nameAr: 'شفشاون',          nameFr: 'Chefchaouen',       order: 55 },
    { code: 'LQLIAA',       name: 'Lqliaa',            nameAr: 'القليعة',         nameFr: 'Lqliaa',            order: 56 },
    { code: 'AOUSSERD',     name: 'Aousserd',          nameAr: 'أوسرد',           nameFr: 'Aousserd',          order: 57 },
  ]
  ...
  for (const c of citiesData) {
    const city = await prisma.city.upsert({
      where: { code: c.code },
      update: { nameAr: c.nameAr, nameFr: c.nameFr, order: c.order },
      create: { ...c, countryId: morocco.id, isActive: true },
    })
